...
| <code><a href="#@time-loop/cdk-lambda-eni-usage-metric-publisher.LambdaEniUsageMetricPublisher.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@time-loop/cdk-lambda-eni-usage-metric-publisher.LambdaEniUsageMetricPublisher.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@time-loop/cdk-lambda-eni-usage-metric-publisher.LambdaEniUsageMetricPublisher.with.parameter.mixins"></a>
